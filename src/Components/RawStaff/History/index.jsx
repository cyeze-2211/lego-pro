            ...
            <div className={`relative overflow-hidden rounded-2xl border px-5 py-4 shadow-md ${panel}`}>
                ...
                <div className="relative flex flex-wrap items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className={`text-xl font-bold tracking-tight ${head}`}>Xom ashyo Tarixi</h1>
                                    ...
                                    {filtered.map((t, idx) => (
                                        <tr key={t.id} className={`transition-colors ${rowHov}`}>
                                            ...
                                            <td className="px-5 py-3.5">
                                                <span className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-bold ${t.action === 'IN' ? 'bg-emerald-500/10 text-emerald-500' : 'bg-rose-500/10 text-rose-500'}`}>
                                                    {t.action === 'IN' ? <LuLogIn size={11} /> : <LuLogOut size={11} />}
                                                    {t.action === 'IN' ? 'Kirim' : 'Chiqim'}
                                                </span>
                                            </td>
                                ...
                                <div key={t.id} className={`flex items-center justify-between gap-3 px-4 py-3.5 transition-colors ${rowHov}`}>
                                    <div className="flex items-center gap-3 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            <p className={`truncate font-semibold text-sm ${head}`}>{t.rawMaterialName}</p>
